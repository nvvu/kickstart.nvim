...
vim.keymap.set('n', 'gs', '^', { desc = 'Go to first non-whitespace char of the line' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>b', '<cmd>Telescope buffers sort_mru=true sort_lastused=true<cr>', { desc = '[B]uffers' })
      vim.keymap.set('n', '<leader>sb', builtin.current_buffer_fuzzy_find, { desc = 'Fuzzily [S]earch in current [B]uffer' })
